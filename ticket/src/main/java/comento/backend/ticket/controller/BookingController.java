...
public class BookingController {
	...
	public BookingController(BookingService bookingService, BookingHistoryService bookingHistoryService,
		UserService userService, PerformanceService performanceService, SeatService seatService) {
	...
	public ResponseEntity<Object> addBooking(@Valid @RequestBody BookingDto reqBooking) {
		...
		final Seat seat = seatService.getIsBooking(performance, reqBooking.getSeatType(),
			reqBooking.getSeatNumber()); //false라면 예약 가능
